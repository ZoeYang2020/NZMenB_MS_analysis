...
input=/home/zyang/NGS/active/IPL/MENINGO/analysis/HRC/zoe/AllNZMemB_2021/SNPs/154clade_SNPs/154cladeNZmenB_raw.vcf
x=clade154_2out
...
/home/zyang/NGS/active/IPL/MENINGO/analysis/HRC/zoe/bin/bedtools intersect -a ${x}QualDPsmpcomCore07Rf0_pNoindelRf0.vcf -b NMI97348_tandem_ref_bed -v > ${x}_rmtanden.vcf
