#!/bin/bash
cd /home/zyang/NGS/active/IPL/MENINGO/analysis/HRC/zoe/AllNZMemB_2021/snps_filt
export PERL5LIB=/home/zyang/NGS/transfer/bugnome/home/una/applications/vcftools_0.1.12b/perl/
input=/home/zyang/NGS/active/IPL/MENINGO/analysis/HRC/zoe/AllNZMemB_2021/SNPs/41_138_SNPs/41_138_raw.vcf
x=41_138
...
#all 1154 samples contains either a reference or a mutation
#vcffilter -f "AN = 1174" ${x}AC.vcf > ${x}ACAN.vcf
...
/home/zyang/NGS/active/IPL/MENINGO/analysis/HRC/zoe/bin/bedtools intersect -a ${x}QualDPsmpcomCore07Rf0_pNoindelRf0.vcf -b NMI01191_tandem_ref_bed -v > ${x}_rmtanden.vcf
...
#extract mallele
y=41_138_mallele
mv ${x}_header.vcf ${y}.vcf

gzip -c ${y}.vcf  > ${y}.vcf.gz

zcat ${y}.vcf.gz | vcf-to-tab | sed 's|/||g' > ${y}SNPs.tab

vcftools --extract-FORMAT-info GT --vcf  ${y}.vcf --out ${y}SNPs_GT
