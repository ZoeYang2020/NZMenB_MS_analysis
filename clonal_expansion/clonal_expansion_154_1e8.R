...
write.csv(expansions$model_data, file="./154_1e8_2_expansion_model_data.csv")
write.csv(expansions$expansion_data, file="./154_1e8_2_expansion_expansion_data.csv")


## ----plot traces, out.width="90%", fig.width=10, fig.height=10, dpi=300, fig.align="center", message=FALSE, eval=T----

svg(file="./154_1e8_2_trace.svg")
...
svg(file="./154_1e8_2_summary_k4.svg")
plot(expansions,mode="summary", k_modes=4)
dev.off()


svg(file="./154_1e8_2_summary_k5.svg")
plot(expansions,mode="summary", k_modes=5)
dev.off()

svg(file="./154_1e8_2_summary_k6.svg")
plot(expansions,mode="summary", k_modes=6)
dev.off()

svg(file="./154_1e8_2_summary_k7.svg")
...
svg(file="./154_1e8_2_summary_node_k4.scg")
plot(expansions, mode="modes", k_modes=4)
dev.off

svg(file="./154_1e8_2_summary_node_k5.scg")
plot(expansions, mode="modes", k_modes=5)
dev.off

svg(file="./154_1e8_2_summary_node_k6.scg")
plot(expansions, mode="modes", k_modes=6)
dev.off

svg(file="./154_1e8_2_summary_node_k7.scg")
...
svg(file="./154_1e8_2_population_k4.svg")
plot(expansions, mode="popfunc", k_modes=4)
dev.off()

svg(file="./154_1e8_2_population_k5.svg")
plot(expansions, mode="popfunc", k_modes=5)
dev.off()

svg(file="./154_1e8_2_population_k6.svg")
plot(expansions, mode="popfunc", k_modes=6)
dev.off()

svg(file="./154_1e8_2_population_k7.svg")
