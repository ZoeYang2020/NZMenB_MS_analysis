...
cat clade41_99_raw_region1.vcf >combined_41_99_raw_SNPs.vcf

tail -12974  clade41_99_raw_region2.vcf >>combined_41_99_raw_SNPs.vcf 
tail -14732  clade41_99_raw_region3.vcf >>combined_41_99_raw_SNPs.vcf 
tail -12698  clade41_99_raw_region4.vcf >>combined_41_99_raw_SNPs.vcf
tail -5054   clade41_99_raw_region5.vcf >>combined_41_99_raw_SNPs.vcf


bcftools view -H combined_41_99_raw_SNPs.vcf  |sort -u -k2,2n -k4,4d -k5,5d >combined_41_99_raw_SNPs_rmdup.vcf

head -62  clade41_99_raw_region1.vcf > head_62

cat combined_41_99_raw_SNPs_rmdup.vcf >>head_62 


mv head_62 41_99_raw.vcf
